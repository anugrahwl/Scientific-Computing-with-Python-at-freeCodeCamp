# Budget App
_Submission in Scientific Computing with Python on freeCodeCamp_

Budget App is a simple text-based program that saves your bank account activities, runs on terminal. Perhaps :)
